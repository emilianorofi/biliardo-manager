        ...
        <div className="space-y-2">
          {userListings.map((listing) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <Link href={`/players/${listing.playerId}?from=market`}><PlayerPortrait player={{ id: listing.playerId, firstName: listing.firstName, lastName: listing.lastName, nationality: listing.nationality, age: listing.age }} className="aspect-[2/3] w-16" /></Link>
          ...
          {userBids.map((bid) => (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  <div className="flex items-center gap-3">
                    <Link href={`/players/${bid.playerId}?from=market`}><PlayerPortrait player={{ id: bid.playerId, firstName: bid.firstName, lastName: bid.lastName, nationality: bid.nationality, age: bid.age }} className="aspect-[2/3] w-16" /></Link>
