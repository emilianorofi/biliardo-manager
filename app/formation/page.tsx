...
import FormationStrategyBoard from "../components/formation/FormationStrategyBoard";
      ...
      : nextPlayableRound === null
        ...
        : !currentFixture
          ...
          : currentFixture.status ===
            ...
            : `Prossimo incontro contro ${opponent?.name ?? "avversario da definire"}. Imposta titolari, riserve e cambi entro venerdì alle 20:59.`;
